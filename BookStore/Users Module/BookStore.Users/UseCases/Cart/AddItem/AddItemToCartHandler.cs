...
#nullable disable
    ...
    var booksAssembly = Assembly.Load("BookStore.Books");

    // Dynamically get the IBookRepository type
    var bookRepositoryType = booksAssembly.GetType("BookStore.Books.IBookRepository");
    ...
    var bookServiceType = booksAssembly.GetType("BookStore.Books.BookService");
